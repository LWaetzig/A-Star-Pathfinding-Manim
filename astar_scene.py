...
class AStarScene(Scene):
    def construct(self):
        ...
        way = VGroup(p1, p2, p3, line1, line2, line3).rotate(0.25 * PI).move_to(ORIGIN)
        ...
        # display title and move to upper left corner
        self.wait(2)
        ...
        # display founding fathers with pictures and names
        self.play(
        ...
        # explain components and advantages
