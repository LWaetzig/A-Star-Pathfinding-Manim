...
class HeuristicScene(MovingCameraScene):
    def construct(self):
        ...
        letter_s = Text("Start", font_size=30).move_to(point_s.get_center())
        letter_x = MathTex("x", font_size=60).move_to(point_x.get_center())
        letter_e = Text("End", font_size=30).move_to(point_e.get_center())
        ...
        # Create other stuff
        arrow1 = Arrow(2.4 * UP, 1 * UP, buff=0.35)
        arrow2 = Arrow(1 * UP, 0.5 * DOWN , buff=0.35)
        arrow3 = Arrow(0.5 * DOWN, 2 * DOWN, buff=0.35)
